...
ENV BASE_PKG="tmux gnome-shell unzip neovim htop qemu-guest-agent ghostty distrobox flatpak @container-management @hardware-support @guest-desktop-agents zsh rsync niri ecryptfs-utils swaylock"
